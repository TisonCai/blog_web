...
class SideBar(models.Model):
    ...
    def content_html(self):
        ...
        if self.display_type == self.DISPLAY_HTML:
            ...
            result = render_to_string('config/blocks/sidebar_post.html',context=context)
        ...
        elif self.display_type == self.DISPLAY_Author:
            context = {
                'sidebar': self
            }
            print("0000000")
            print(context)
            result = render_to_string('config/blocks/sidebar_author.html', context=context)
        return result
